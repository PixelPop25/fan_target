...
static volatile int g_lightbar_temp = -1;
...
static void apply_overlay_position(void) {
  ...
  case OVERLAY_TOP_RIGHT: x = 1740; y = 20; break;
  case OVERLAY_BOTTOM_LEFT: x = 20; y = 980; break;
  case OVERLAY_BOTTOM_RIGHT: x = 1740; y = 980; break;
  default: break;
  }
